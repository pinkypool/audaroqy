        ...
        >
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <div className="p-3 border-b border-neutral-700 bg-[#1a2a32] flex items-center justify-between">
                    <h2 className="text-sm font-bold text-white uppercase tracking-wider">Перевод</h2>
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            value={language}
                            onChange={e => onLanguageChange && onLanguageChange(e.target.value as 'ru' | 'kz')}
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#1a2a32]">
                    {!word ? (
                        <div className="h-full flex flex-col items-center justify-center text-neutral-500 p-6">
                            ...
                            <p className="text-center text-sm">Нажмите на любое слово в тексте для перевода</p>
                        </div>
                    ) : (
                        <>
                            {/* Word Section */}
                            <div className="bg-neutral-800/50 rounded-xl p-4 border border-neutral-700">
                                ...
                                <div className="border-t border-neutral-700 pt-2">
                                    ...
                                    {isLoadingWord ? (
                                        ...
                                        <p className="text-lg text-green-400 font-medium">{translation || 'Ошибка'}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="bg-neutral-800/50 rounded-xl border border-neutral-700 overflow-hidden">
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="font-bold text-sm text-white">Контекст предложения</span>
                                    </div>
                                ...
                                {showSentence && (
                                    <div className="p-4 pt-0 border-t border-neutral-700/50">
                                        ...
                                        {!sentenceTranslation ? (
                                            ...
                                            >
                                                {isLoadingSentence ? 'Перевожу...' : 'Перевести предложение'}
                                            </button>
                                        ) : (
                                            <div className="space-y-3">
                                                ...
                                                {grammar && (
                                                    <div className="bg-blue-500/10 rounded-lg p-3 border border-blue-500/20">
                                                        <span className="text-xs text-blue-400 uppercase tracking-wider font-bold">Грамматика</span>
